...
#ifndef _WIN32
static char oldCwd[PT2_PATH_MAX];
#endif
...
// 				lineLen -= i;
// 				if (lineLen > 0)
// 					strncpy(config.defModulesDir, &configLine[i], (lineLen > PT2_PATH_MAX) ? PT2_PATH_MAX : lineLen);
// 			}
// 		}
// 
// 		// DEFAULTSMPDIR
...
// 				lineLen -= i;
// 				if (lineLen > 0)
// 					strncpy(config.defSamplesDir, &configLine[i], (lineLen > PT2_PATH_MAX) ? PT2_PATH_MAX : lineLen);
// 			}
// 		}
// 
// 		// FILTERMODEL
